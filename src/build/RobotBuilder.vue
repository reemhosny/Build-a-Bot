   ...
   <button class="add-to-cart" @click="addToCart()">Add to Cart</button>
    <div class="top-row">
      <div class="top part">
        ...
        <button @click="selectedPreviosHead()"  class="prev-selector">&#9668;</button>
    ...
    <div class="middle-row">
      <div class="left part">
        ...
        <button @click="selectedPreviosLeftArm()" class="prev-selector">&#9650;</button>
        <button @click="selectNextLeftArm()" class="next-selector">&#9660;</button>
      </div>
      <div class="center part">
        <img :src="selectedRobot.torsos.src" title="left arm"/>
        <button @click="selectedPreviosTorso()" class="prev-selector">&#9668;</button>
        <button @click="selectNextTorso()" class="next-selector">&#9658;</button>
      </div>
      <div class="right part">
        <img :src="selectedRobot.rightArm.src" title="left arm"/>
        <button @click="selectedPreviosRightArm()" class="prev-selector">&#9650;</button>
        <button @click="selectedNextRightArm()" class="next-selector">&#9660;</button>
      </div>
    </div>
    <div class="bottom-row">
      <div class="bottom part">
        <img :src="selectedRobot.base.src" title="left arm"/>
        <button @click="selectedPreviosBase()" class="prev-selector">&#9668;</button>
        <button @click="selectedNextBase()" class="next-selector">&#9658;</button>
      </div>
    </div>
    <div>
      <h1>Cart</h1>
      <table>
        ...
        <tbody>
          <tr v-for="robot in cart" :key="robot.index"></tr>
  ...
  methods: {
    ...
    selectedPreviosBase() {
      this.selectedBaseIndex = getPreviousValidIndex(
        this.selectedBaseIndex, availableParts.arms.length,
      );
    },
    selectedNextBase() {
